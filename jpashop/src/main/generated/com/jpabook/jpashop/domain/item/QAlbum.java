...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = -430008726L;
    ...
    //inherited
    public final ListPath<com.jpabook.jpashop.domain.Category, com.jpabook.jpashop.domain.QCategory> categories = _super.categories;
